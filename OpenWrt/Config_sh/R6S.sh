...
uci set ddns.cloudflare.username="1094890624@qq.com"
uci set ddns.cloudflare.password="$(AES_D "w9LPasIOkMyKZ6n8IhY2oHzcBuY2UYzV5I8Eh5ETCfi3Z5fNjtvxbcLglwKQJFz4")"
...
if [ ! -n "$(uci -q get network.MODE)" ]; then
	...
	uci set network.MODE.ipaddr="192.168.1.9"
	uci set network.MODE.gateway="192.168.1.10"
